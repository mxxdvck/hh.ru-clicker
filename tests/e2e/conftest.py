...
def default_state() -> dict:
    ...
    return {
        ...
        "config": {
            ...
            "auto_pick_resume": True,
            "default_client_mode": "web",
            "daily_apply_limit": 20,
            "run_apply_limit": 20,
            "search_only_mode": True,
            "merge_saved_searches": False,
            "auto_resume_search_enabled": False,
            "merge_favorited_vacancies": False,
            "hh_daily_limit": 200,
            "fresh_vacancies_mode": False,
            "fresh_vacancy_hours": 24,
            "fresh_apply_reserve": 50,
            ...
            "min_employer_reviews": 3,
            "min_recommendations_percent": 0,
            "skip_auto_response_vacancies": False,
            "prefer_quick_responses": False,
            "accredited_it_only": False,
            "hh_region": "",
            "llm_applicant_gender": "female",
            "use_websocket_realtime": False,
            "llm_ws_push_enabled": True,
            "chat_use_oauth": False,
            "llm_enabled": False,
            "llm_auto_send": False,
            "llm_fill_questionnaire": False,
            "llm_use_cover_letter": True,
            "llm_generate_cover_letter": False,
            "llm_use_resume": True,
            "llm_use_quick_replies": False,
